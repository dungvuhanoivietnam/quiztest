...
//            mainViewModel.fetchQuestion()
        ...
        lstOptopn.add(OptionsAnswer("", "Cái giá 2", "IMAGE", 1))
        lstOptopn.add(OptionsAnswer("", "Cái giá 3", "IMAGE", 1))
        lstOptopn.add(OptionsAnswer("", "Cái giá 4", "IMAGE", 1))

        // option text
        lstOptopn1.add(OptionsAnswer("", "Cái giá 1 ", "TEXT", 1))
        lstOptopn1.add(OptionsAnswer("", "Cái giá 2", "TEXT", 1))
        lstOptopn1.add(OptionsAnswer("", "Cái giá 3", "TEXT", 1))
        lstOptopn1.add(OptionsAnswer("", "Cái giá 4", "TEXT", 1))
